  ...
  <td>
    ...
    <tr>
      ...
      <td nowrap style="padding-bottom: 2px;">
         <span style="font-size: 7pt; font-style: oblique; color: #888888;"><gts:var>${version}</gts:var></span>
         &nbsp;&nbsp;
         <gts:var ifKey="login.showPiLink" compare="ne" value="false">
         <a style="font-size: 11pt; text-decoration: none;" href="${login.piLink=http://www.opengts.org}" target="_blank">&pi;</a>&nbsp;
         </gts:var>
      </td>
    </tr>
    </tbody>
