...
public class DBConfig
{
    ...
    *** OBSOLETE
    *** Runtime Configuration Property<br>
    *** True to have the WorkOrder "Download Samples" return all status codes.<br>
    *** Type: Boolean
    **/
    public static final String PROP_WorkOrder_allStatusCodes        = "WorkOrder.allStatusCodes";
        ...
        if (RTConfig.hasProperty(ARG_CREATE_SYSADMIN)) {
            ...
            try {
                ...
                if (Account.exists(sysAdminAcct)) {
                    ...
                    Account.createNewAccount(sysAdminAcct, sysAdminPass);
