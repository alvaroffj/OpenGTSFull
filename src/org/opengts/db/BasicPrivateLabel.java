    ...
    implements RTConfig.PropertySetter
{
    ...
    public  static final String LAF_Color_Background                    = "Color.background";
  ...
  //private Map<String,String>          hostAliasMap            = null;
    ...
    private String                      privLblAdminAccountID   = "";
    ...
    **/
    ...
    {
        return this.domainName; // may be null
    }
    ...
    **/
    ...
    /** 
    *** Sets the SysAdmin accountID for this PrivatelLabel
    *** @param sysAdminID  The systemAdmin account ID
    **/
    public void setPrivateLabelAdminAccount(String sysAdminID)
    {
        this.privLblAdminAccountID = StringTools.trim(sysAdminID);
    }
    
    /**
    *** Gets the SysAdmin accountID for this PrivateLabel
    *** @return The SysAdmin accountID for this PrivateLabel
    **/
    public String getPrivateLabelAdminAccount()
    {
        return StringTools.trim(this.privLblAdminAccountID);
    }

    /**
    *** Returns true if the specified account ID is the PrivateLabelAdmin AccountID for this PrivateLabel
    *** @param acctID  The Account ID to test for PrivateLabelAdmin
    *** @return True if the specified account ID is the PrivateLabelAdmin AccountID for this PrivateLabel
    **/
    public boolean isPrivateLabelAdminAccountID(String acctID)
    {
        if (StringTools.isBlank(acctID)) {
            return false;
        } else {
            String plaa = this.getPrivateLabelAdminAccount();
            return !StringTools.isBlank(plaa)? plaa.equals(acctID) : false;
        }
    }
    ...
    *** @param localMap  The supported Locale map
    **/
