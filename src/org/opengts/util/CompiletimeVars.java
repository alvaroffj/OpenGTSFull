            ...
            if (daysUntilRTP != null) {
                ...
                if ((daysUntil.indexOf("/") >= 0) || (daysUntil.indexOf(":") >= 0)) {
                    ...
                    try {
                        ...
                        long     nowDN = DateTime.getDayNumberFromDate(nowDT);
                        long     futDN = DateTime.getDayNumberFromDate(futDT);
                        long     delta = futDN - nowDN;
                        if (delta <= 0L) { delta = 1L; }
                        daysUntilRTP.setString(daysUntil_key     , String.valueOf(delta));
            ...
            if (secUntilRTP != null) {
                ...
                if ((secUntil.indexOf("/") >= 0) || (secUntil.indexOf(":") >= 0)) {
                    ...
                    try {
                        ...
                        long     delta  = futSec - nowSec;
                        if (delta <= 0L) { delta = 1L; }
                        secUntilRTP.setString(secUntil_key     , String.valueOf(delta));
