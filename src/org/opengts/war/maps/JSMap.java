    ...
    extends MapProviderAdapter
{
    ...
    public  static final String MAP_ID                  = "jsmap";
    ...
    **/
        ...
        throws IOException 
    {
        ...
        JavaScriptTools.writeJSVar(out, "MAP_ID"                , MAP_ID);
        ...
        JavaScriptTools.writeJSVar(out, "TEXT_PING_OK"              , i18n.getString("JSMap.pingDevice.ok"  , "A location request has been sent.\nThe {0} should respond shortly ...",devTitles));
        JavaScriptTools.writeJSVar(out, "TEXT_PING_ERROR"           , i18n.getString("JSMap.pingDevice.err" , "The location request failed.\nThe {0} may not support this feature ...",devTitles));
