    ...
    implements Constants
{
  ...
  //public  static final String PARM_ACCT_ACTIVE        = "a_actv";
    ...
    public  static final String PARM_PRIV_LABEL         = "a_privlabel";
    public  static final String PARM_RG_MODE            = "a_rgmode";
    public  static final String PARM_IS_BCROSS          = "a_bcross";
        ...
        throws IOException
    {
        ...
        if (updateAccount) {
            ...
            if (SubmitMatch(submit,i18n.getString("AccountInfo.change","Change"))) {
              ...
              //String acctActive   = AttributeTools.getRequestString(request, PARM_ACCT_ACTIVE, "");
                ...
                String privLabelNam = AttributeTools.getRequestString(request, PARM_PRIV_LABEL,"");
                String revGeoMode   = AttributeTools.getRequestString(request, PARM_RG_MODE,"");
                String isBCrossStr  = AttributeTools.getRequestString(request, PARM_IS_BCROSS, "");
                ...
                try {
                    ...
                    //if (currAcct.getIsActive() != acctActv) { 
                    //    currAcct.setIsActive(acctActv); 
                    //}
                    // contact name
                    ...
                    // notify email
                    if (StringTools.isBlank(notifyEmail) || EMail.validateAddresses(notifyEmail)) {
                        currAcct.setNotifyEmail(notifyEmail);
                    } else {
                        m = i18n.getString("AccountInfo.pleaseEnterNotifyEMail","Please enter a valid notify email address");
                        error = true;
                        saveOK = false;
                    }
                    // timezone
                    ...
                    if (Account.SupportsBorderCrossing()) {
                        ...
                        if (currAcct.getIsBorderCrossing() != isBCross) { 
                            currAcct.setIsBorderCrossing(isBCross); 
                        }
                    }
                    // 'Device' title
                    ...
                    if (saveOK) {
                        currAcct.save();
                        AttributeTools.setSessionAttribute(request, Calendar.PARM_TIMEZONE, timeZone);
        ...
        HTMLOutput HTML_CONTENT  = new HTMLOutput(CommonServlet.CSS_CONTENT_FRAME, m) {
            public void write(PrintWriter out) throws IOException {
              ...
              //String chgURL  = EncodeMakeURL(reqState,Track.BASE_URI(),pageName,COMMAND_INFO_UPDATE);
                ...
                // frame content
                ComboOption isBCross         = ComboOption.getYesNoOption(locale, currAcct.isBorderCrossing()    );
                ...
                //    ComboOption acctActive = ComboOption.getYesNoOption(locale, currAcct.getIsActive());
                //    out.println(FormRow_ComboBox(PARM_ACCT_ACTIVE,_allowEdit, i18n.getString("AccountInfo.active","Active")+":"                      , acctActive       , _ynList, "", -1));
                //}
              ...
              //out.println(FormRow_TextField(PARM_PRIV_LABEL   , false     , i18n.getString("AccountInfo.privateLabelName","PrivateLabel Name:")    , currAcct.getPrivateLabelName(), 24, 32));
                out.println(FormRow_ComboBox (PARM_RG_MODE      , _allowEdit, i18n.getString("AccountInfo.geocoderMode","Geocoder Mode:")            , geocoderMode     , _rgList, null, 10));
                if (Account.SupportsBorderCrossing()) {
                out.println(FormRow_ComboBox (PARM_IS_BCROSS    , _allowEdit, i18n.getString("AccountInfo.isBorderCross","Enable Border Crossing:")  , isBCross         , ComboMap.getYesNoMap(locale), "", -1));
                }
