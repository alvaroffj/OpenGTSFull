        ...
        if (newUser) {
            ...
            if (createUserOK) {
                try {
                    ...
                    String password     = User.isAdminUser(newUserID)? currAcct.getPassword()     : null;
                    User user = User.createNewUser(currAcct, newUserID, contactEmail, password); // already saved
                    reqState.setUserList(null);
