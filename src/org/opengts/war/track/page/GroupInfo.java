            ...
            HTML_CONTENT = new HTMLOutput(CommonServlet.CSS_CONTENT_FRAME, m) {
                public void write(PrintWriter out) throws IOException {
                  ...
                  //String menuURL    = EncodeMakeURL(reqState,Track.BASE_URI(),PAGE_MENU_TOP);
                    ...
                    String editURL    = GroupInfo.this.encodePageURL(reqState);//,Track.BASE_URI());
                    String selectURL  = GroupInfo.this.encodePageURL(reqState);//,Track.BASE_URI());
                    String newURL     = GroupInfo.this.encodePageURL(reqState);//,Track.BASE_URI());
                    ...
                    out.write(i18n.getString("GroupInfo.groupID","{0} ID",grpTitles)+": <input type='text' name='"+PARM_NEW_NAME+"' value='' size='32' maxlength='32'><br>\n");
