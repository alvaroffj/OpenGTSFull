    ...
    implements Constants
{
        ...
        throws IOException
    {
        ...
        final boolean showDeviceLink = !isFleet && Device.supportsLinkURL() && 
            privLabel.getBooleanProperty(PrivateLabel.PROP_TrackMap_showDeviceLink,true);
        ...
        if (device == null) {
            ...
            String blvlProp = privLabel.getStringProperty(PrivateLabel.PROP_TrackMap_showBatteryLevel,"").toLowerCase();
        ...
        final boolean collapsibleControls       = 
            privLabel.getBooleanProperty(PrivateLabel.PROP_TrackMap_mapControlCollapsible,false);
        ...
        HTMLOutput HTML_CONTENT = new HTMLOutput((mapAutoSize? CommonServlet.CSS_CONTENT_MAP_FULL : CommonServlet.CSS_CONTENT_MAP), m) {
            public void write(PrintWriter out) throws IOException {
                ...
                // Find Address
                if (privLabel.getBooleanProperty(PrivateLabel.PROP_TrackMap_enableGeocode,false)) {
                    ...
                    if ((gcp != null) && !gcp.getName().startsWith("geonames")) {
                        ...
                        Print.logInfo("'"+PrivateLabel.PROP_TrackMap_enableGeocode+"' not defined ...");
                ...
                */
                ...
                if (privLabel.getBooleanProperty(PrivateLabel.PROP_TrackMap_showLegend,true)) {
                    String legendTable = mapProvider.getIconSelectorLegend(reqState);
                    if (!StringTools.isBlank(legendTable)) {
                        //Print.logInfo("LegendTable: " + legendTable);
                        ...
                        //Print.logInfo("LegendHtml: " + legendHtml);
                        // currAcct
