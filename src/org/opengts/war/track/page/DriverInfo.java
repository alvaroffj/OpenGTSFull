            ...
            HTML_CONTENT = new HTMLOutput(CommonServlet.CSS_CONTENT_FRAME, m) {
                public void write(PrintWriter out) throws IOException {
                  ...
                  //String menuURL    = EncodeMakeURL(reqState,Track.BASE_URI(),PAGE_MENU_TOP);
                    ...
                    String editURL    = DriverInfo.this.encodePageURL(reqState);//,Track.BASE_URI());
                    String selectURL  = DriverInfo.this.encodePageURL(reqState);//,Track.BASE_URI());
                    String newURL     = DriverInfo.this.encodePageURL(reqState);//,Track.BASE_URI());
                    ...
                    out.write(i18n.getString("DriverInfo.driverID","Driver ID")+": <input type='text' name='"+PARM_NEW_NAME+"' value='' size='32' maxlength='32'><br>\n");
