...
public class Calendar
{
    ...
    public  static final String  PARM_RANGE_FR              = PARM_DATE + "_fr";    // "date_fr"
    public  static final String  PARM_RANGE_FR2             = PARM_RANGE_FR + "2";  // "date_fr2"
    public  static final String  PARM_RANGE_TO              = PARM_DATE + "_to";    // "date_to"
    public  static final String  PARM_RANGE_TO2             = PARM_RANGE_TO + "2";  // "date_to2"

    public  static final String  PARM_TIMEZONE              = PARM_DATE + "_tz";    // "date_tz"
