    ...
    implements StringTools.KeyValueMap
{
    ...
    private static String       DemoAccount                 = Account.DEMO_ACCOUNT_ID;
    private static String       DemoDevice_1                = Account.DEMO_DEVICE_ID_1;
    private static String       DemoRange_1[]               = Account.DEMO_DATE_RANGE_1;
    private static String       DemoDevice_2                = Account.DEMO_DEVICE_ID_2;
    private static String       DemoRange_2[]               = Account.DEMO_DATE_RANGE_2;
