    ...
    implements WebPage
{
    ...
    **/
    public static String getFilteredID(RequestProperties reqState, String propKey, String id)
    {
        ...
        if ((reqState == null) || reqState.getPrivateLabel().getBooleanProperty(propKey,true)) {
            return StringTools.trim(AccountRecord.getFilteredID(id,false,true));
        } else {
    ...
    {
        return Form_TextField(null, name, editable, value, null, size, maxLen);
    }
    ...
    public static String Form_TextField(String id, String name, boolean editable, 
        ...
        int size, int maxLen)
    {
        return Form_TextField(id, name, editable, value, null, size, maxLen);
    }
    ...
    public static String FormRow_ComboBox(String id, String key, boolean editable, String desc, ComboOption sel, ComboMap map, String onchange, int size, String trailingHtml)
    {
        if (editable) {
            ...
            /* form input */
            sb.append("<td class='"+CommonServlet.CSS_ADMIN_VIEW_TABLE_DATA+"'>");
            sb.append(Form_ComboBox(id, key, true, map, sel, onchange, size));
            if (!StringTools.isBlank(trailingHtml)) {
                sb.append(" ").append(trailingHtml);
            }
            sb.append("</td>");
        ...
        throws IOException
    {
        ...
        if (!isAbsolute && reqState.getEncodeEMailHTML()) {
