...
public class DBField
{
            ...
            if (fld != null) {
                ...
                if (prefST.equalsIgnoreCase(this.sqlType)) {
                    ...
                    if (DBProvider.areTypesEquivalent(prefDT,dbpDT)) {
                        ...
                        this.dataType = dbpDT;
                        Print.logInfo("SQL type mismatch: " + this.sqlType + "[" + dbpDT + "] <==> " + prefST + "[" + prefDT + "]");
    ...
    **/
    public DBField(String fldName, Class javaClass, String dataType, I18N.Text title, String attr)
    {
        ...
        /* unique key */
        this.isUniqueKey = this.isPriKey || this.getBooleanAttribute(ATTR_UNIQUE,false);
        ...
        /* required/optional? */
        if (this.isPriKey || this.isUniqueKey || (this.altIndexNames != null)) {
