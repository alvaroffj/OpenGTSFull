...
public class DBFieldValues
{
    ...
    **/
    public void setAllFieldValues(ResultSet rs) 
        throws SQLException
    {
        this.setAllFieldValues(rs, true);
    }
    ...
    *** @throws SQLException If field does not exist
    **/
    public void setAllFieldValues(ResultSet rs, boolean setKeyFields) 
        throws SQLException
    {
        if (rs == null) {
            // quietly ignore
        ...
        if (this.recordKey != null) {
            ...
            DBField fld[] = this.recordKey.getFields();
            for (int i = 0; i < fld.length; i++) {
                if (setKeyFields || !fld[i].isPrimaryKey()) {
                    try {
    ...
    **/
    public void setAllFieldValues(Map<String,String> valMap) 
        throws DBException
    {
        this.setAllFieldValues(valMap, true/*setKeyFields*/);
    }

    /**
    *** Sets all field values from the specified value map (all fields required)
    *** @param valMap  The Field==>Value map
    *** @param setKeyFields True if key fields should also be set
    *** @throws DBException If field does not exist
    **/
    public void setAllFieldValues(Map<String,String> valMap, boolean setKeyFields) 
        throws DBException
    {
        this.setFieldValues(valMap, setKeyFields, true/*requireAllFields*/);
    }
    ...
    *** @throws DBException If field does not exist
    **/
    public void setFieldValues(Map<String,String> valMap, boolean setKeyFields, boolean requireAllFields) 
        throws DBException
    {
        if (this.recordKey != null) {
            String tblName = this.getTableName();
