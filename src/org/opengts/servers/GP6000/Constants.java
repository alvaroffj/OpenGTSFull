...
public class Constants
{
    ...
    public static final String  TITLE_NAME              = "GP6000 Server";
    public static final String  VERSION                 = "0.1.0";
    public static final String  COPYRIGHT               = Version.getCopyright();
    
    // ------------------------------------------------------------------------

    public static final String  DEVICE_CODE             = DCServerFactory.GP6000_NAME;
    ...
    public static final int     MAX_PACKET_LENGTH       = 6000;
