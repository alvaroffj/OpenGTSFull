...
public class CheckInstall
{
    ...
    {
        String nameFmt = "  " + StringTools.leftAlign(name,22) + " ==> ";
    ...
    public static void main(String argv[])
    {
        ...
        if (RTConfig.hasProperty(DBConfig.PROP_ServiceAccount_ID)) {
            String srvID   = RTConfig.getString(DBConfig.PROP_ServiceAccount_ID  ,"?");
            String srvName = RTConfig.getString(DBConfig.PROP_ServiceAccount_Name,"?");
        ...
        // DBPrivider
        {
            String dbProv = RTConfig.getString(RTKey.DB_PROVIDER,"");
            if (StringTools.isBlank(dbProv)) {
                ...
                addError("The DB provider has not been specified.",
                         "Missing '"+RTKey.DB_PROVIDER+"' specification in 'default.conf'.",
                         "Please include '"+RTKey.DB_PROVIDER+"' specification in 'default.conf'.");
            } else
        ...
        // DB User
        {
            ...
            if (StringTools.isBlank(dbUser)) {
                ...
                addError("The DB user has not been specified.",
                         "Missing '"+RTKey.DB_USER+"' specification in 'default.conf'/'common.conf'.",
                         "Please include '"+RTKey.DB_USER+"' specification in 'default.conf'/'common.conf'.");
            } else
        ...
        // RuleFactory
        {
            ...
            if (ruleFact != null) {
                ...
                if (compileTime > 0L) {
                    v.append(" ").append((new DateTime(compileTime)).gmtFormat("yyyy/MM/dd HH:mm:ss z"));
                }
            ...
            if (!hasSMTPHost) {
                ...
                try {
                    ...
                    addError("Unable to connect to the SMTP host '"+smtpHost+"'.",
                             "Invalid SMTP host specified in 'common.conf'.",
